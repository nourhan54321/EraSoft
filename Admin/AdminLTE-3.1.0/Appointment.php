<?php 
 ...
 // Call the allUsers method and store the result
 $res1 = $obj->allAppointment();
...
<head>
  ...
  <title>AdminLTE 3 | Appointment</title>
              ...
              <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?=$row['phone']?></td>
                    <td><?=$row['Name']?></td>
                    <td><form  action="pages/db/delete.php?id=<?=$row['id']?>" method="post">
                         <input type="submit" name="appoint" value="Reject">
                          </form>
                         </td>
                   </tr>
